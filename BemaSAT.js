...
async function ConsultarStatusOperacional(numeroSessao,codigoDeAtivacao) {
  const cancela = await bemafi.ConsultarStatusOperacional(numeroSessao,codigoDeAtivacao)
  console.log( cancela)
  return cancela;
}
