...
const tabst = {
  'SP':{'sittrib':'S','ICMS':'18'},
  'PR':{'sittrib':'S','ICMS':'12'},
  'RS':{'sittrib':'N','ICMS':'12'},
}
  ...
  function defineCFOP() {
    ...
    if (UFDest != UFOrig) {
      if (indIEDest ==1){
        ...
        else if (sittrib == '060' && tabst[UFDest]=='S') {
          return '6404';
          console.log('6404')
        }
        else if (sittrib == '101' && tabst[UFDest]=='S') {
          return '6403';
          console.log('6403')
        }        
      }
