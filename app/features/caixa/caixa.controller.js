(function(){
    ...
    function VendasCtrl ($scope,$q,VendaSrvc,$mdDialog,$location) {
      ...
      function PagamentoCtrl($scope, $mdDialog,locals,$timeout) {  //controla o modal que faz o pagamento
        ...
        var vm = this;
        vm.codbar = '';
        vm.numerocupom = function() {
          console.log(bemafi.nuCupom());
        }         
        vm.keys = {
          ENTER : function(name, code) { if(vm.codbar){vm.insereproduto(vm.codbar);vm.codbar=''}},
          A : function(name, code) { vm.codbar+=name },
          ZERO : function(name, code) { if (vm.codbar) vm.codbar+='0'},
          ONE : function(name, code) { if (vm.codbar) vm.codbar+='1'},
          TWO : function(name, code) { if (vm.codbar) vm.codbar+='2'},
          THREE : function(name, code) { if (vm.codbar) vm.codbar+='3'},
          FOUR : function(name, code) { if (vm.codbar) vm.codbar+='4'},
          FIVE : function(name, code) { if (vm.codbar) vm.codbar+='5'},
          SIX : function(name, code) { if (vm.codbar) vm.codbar+='6'},
          SEVEN : function(name, code) { if (vm.codbar) vm.codbar+='7'},
          EIGHT : function(name, code) { if (vm.codbar) vm.codbar+='8'},
          NINE : function(name, code) { if (vm.codbar) vm.codbar+='9'},
          NUMPAD_0 : function(name, code) { if (vm.codbar) vm.codbar+='0'},
          NUMPAD_1 : function(name, code) { if (vm.codbar) vm.codbar+='1'},
          NUMPAD_2 : function(name, code) { if (vm.codbar) vm.codbar+='2'},
          NUMPAD_3 : function(name, code) { if (vm.codbar) vm.codbar+='3'},
          NUMPAD_4 : function(name, code) { if (vm.codbar) vm.codbar+='4'},
          NUMPAD_5 : function(name, code) { if (vm.codbar) vm.codbar+='5'},
          NUMPAD_6 : function(name, code) { if (vm.codbar) vm.codbar+='6'},
          NUMPAD_7 : function(name, code) { if (vm.codbar) vm.codbar+='7'},
          NUMPAD_8 : function(name, code) { if (vm.codbar) vm.codbar+='8'},
          NUMPAD_9 : function(name, code) { if (vm.codbar) vm.codbar+='9'},
										F3       : function(name, code) {vm.abreVendas('','C')},
										F4       : function(name, code) {vm.abreVendas('','R')},
          F5       : function(name, code) { vm.Pagar()}
        };
        vm.puxaLocal = function(ev) {
          $mdDialog.show({
        ...
        vm.abreVendas = function(ev,status) {
									$scope.venda = [];
									$scope.prodVenda = [];									
        ...
        vm.insereproduto = function(codbar){
          console.log(codbar);
        ...
        vm.leiturax = function (ev){
          console.log(bemafi.leituraX())
				}
        vm.reducaoZ = function (ev){
          console.log(bemafi.reducaoZ())
        }
        vm.acertaHora = function (ev){
          console.log(bemafi.acertaHora())
        }        							
        vm.novaVenda = function(ev){
          $mdDialog.show({
       ...
       // vm.SelecionaVenda = function(venda) {
       //     vm.selecteder = this.item;
       //     console.log($scope.selected);
       //     VendaSrvc.listaProdVenda(venda).then(function(response){
       //       vm.ListaProduto = response;
       //     });             
       // }; 
    };    
})();