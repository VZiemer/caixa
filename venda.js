...
function Venda(lcto, transito, cgc, insc, codcli, nomecli, email, fone, razao, endereco, numero, bairro, cep, codibge, codcidade, cidade, estado, complemento, desconto, frete, seguro, total) {
    //venda
    this.LCTO = []
    this.LCTO.push(lcto)
    //transito
